<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true"
    CodeFile="sales_order_create_1.aspx.cs" Inherits="admin_sales_order_create_1"
    %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_content" runat="Server">
    ...
    <div class="content-header">
        <div id="order-header">
            <h3 class="icon-head head-sales-order">
                Create New Order for Tom Wilson in Doors &amp; Hardware Direct</h3>
        </div>
    ...
    <div id="order-customer-selector" style="display: none;">
                    ...
                    <table class="actions" cellspacing="0">
                        <tbody>
                            <tr>
                                <td class="pager">
                                    Page
                                    <img src="sales_order_create_1_files/pager_arrow_left_off.gif" alt="Go to Previous page"
                                        class="arrow">
                                    <input name="page" value="1" class="input-text page" onkeypress="sales_order_create_customer_gridJsObject.inputPage(event, '1')"
                                        type="text">
                                    <img src="sales_order_create_1_files/pager_arrow_right_off.gif" alt="Go to Previous page"
                                        class="arrow">
                        ...
                        <div class="hor-scroll">
                            <table class="data" id="sales_order_create_customer_grid_table" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="even pointer" title="16">
                                        <td class="a-right">
                                            16
                                        </td>
                                        <td class="">
                                    ...
                                    <tr class="even pointer" title="7">
                                        <td class="a-right">
                                            7
                                        </td>
                                        <td class="">
                                            asdfasdfa asdgasdgasg
                                        </td>
                                        <td class="">
                                            asdfasdfasdf@asgasdf.com
                                        </td>
                                        <td class="">
                                            &nbsp;
                                        </td>
    ...
    <div id="order-data" style="">
        <div class="page-create-order">
            ...
            <table width="100%" cellspacing="0">
                <tbody>
                    <tr>
                        <td class="side-col" style="padding: 0pt; background: transparent none repeat scroll 0% 0%;
                            ...
                            <div id="order-sidebar">
                                <div class="entry-edit">
                                    <div class="entry-edit-head">
                                        <h4>
                                            Customer's Current Activities</h4>
                                    </div>
                                </div>
                                <div class="create-order-sidebar-container">
                                    <div id="order-sidebar_top_button">
                                        <div class="sub-btn-set">
                                            <button id="id_686ad399d8b55c89bc89bcd0fb1aa30f" type="button" class="scalable" onclick="order.sidebarApplyChanges()"
                                                style="">
                                                <span>Update Changes</span></button></div>
                                    </div>
                                    <div id="order-sidebar_cart">
                                        <div class="create-order-sidebar-block" id="sidebar_data_cart">
                                            <div class="head">
                                                <h5>
                                                    Shopping Cart <span class="normal">(0)</span></h5>
                                                <a href="#" title="Refresh" onclick="order.loadArea('sidebar_cart', 'sidebar_data_cart');return false;">
                                                    <img src="sales_order_create_1_files/fam_refresh.gif" alt="Refresh" width="16" height="16">
                                                </a>
                                            </div>
                                            <div class="content">
                                    ...
                                    <div id="order-sidebar_wishlist">
                                        <div class="create-order-sidebar-block" id="sidebar_data_wishlist">
                                            <div class="head">
                                                <h5>
                                                    Wishlist <span class="normal">(0)</span></h5>
                                                <a href="#" title="Refresh" onclick="order.loadArea('sidebar_wishlist', 'sidebar_data_wishlist');return false;">
                                                    <img src="sales_order_create_1_files/fam_refresh.gif" alt="Refresh" width="16" height="16">
                                                </a>
                                            </div>
                                            <div class="content">
                                    ...
                                    <div id="order-sidebar_reorder">
                                        <div class="create-order-sidebar-block" id="sidebar_data_reorder">
                                            <div class="head">
                                                <h5>
                                                    Last ordered items <span class="normal">(1)</span></h5>
                                                <a href="#" title="Refresh" onclick="order.loadArea('sidebar_reorder', 'sidebar_data_reorder');return false;">
                                                    <img src="sales_order_create_1_files/fam_refresh.gif" alt="Refresh" width="16" height="16">
                                                </a>
                                            </div>
                                            <div class="content">
                                                    ...
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <th class="a-center">
                                                                    <img src="sales_order_create_1_files/fam_package_go.gif" alt="Add To Order" width="16"
                                                                        height="16">
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td class="a-center">
                                                                    <input name="sidebar[reorder][20]" value="1" title="Add To Order" type="checkbox">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <div id="order-sidebar_viewed">
                                    </div>
                                    <div id="order-sidebar_compared">
                                        <div class="create-order-sidebar-block" id="sidebar_data_compared">
                                            <div class="head">
                                                <h5>
                                                    Products in Compare List <span class="normal">(0)</span></h5>
                                                <a href="#" title="Refresh" onclick="order.loadArea('sidebar_compared', 'sidebar_data_compared');return false;">
                                                    <img src="sales_order_create_1_files/fam_refresh.gif" alt="Refresh" width="16" height="16">
                                                </a>
                                            </div>
                                            <div class="content">
                                    ...
                                    <div id="order-sidebar_pcompared">
                                        <div class="create-order-sidebar-block" id="sidebar_data_pcompared">
                                            <div class="head">
                                                <h5>
                                                    Recently Compared Products <span class="normal">(0)</span></h5>
                                                <a href="#" title="Refresh" onclick="order.loadArea('sidebar_pcompared', 'sidebar_data_pcompared');return false;">
                                                    <img src="sales_order_create_1_files/fam_refresh.gif" alt="Refresh" width="16" height="16">
                                                </a>
                                            </div>
                                            <div class="content">
                                    ...
                                    <div id="order-sidebar_pviewed">
                                        <div class="create-order-sidebar-block" id="sidebar_data_pviewed">
                                            <div class="head">
                                                <h5>
                                                    Recently Viewed Products <span class="normal">(3)</span></h5>
                                                <a href="#" title="Refresh" onclick="order.loadArea('sidebar_pviewed', 'sidebar_data_pviewed');return false;">
                                                    <img src="sales_order_create_1_files/fam_refresh.gif" alt="Refresh" width="16" height="16">
                                                </a>
                                            </div>
                                            <div class="content">
                                                    ...
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="a-center">
                                                                    <input name="sidebar[add][131]" value="1" title="Add To Order" type="checkbox">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td class="a-center">
                                                                    <input name="sidebar[add][135]" value="1" title="Add To Order" type="checkbox">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td class="a-center">
                                                                    <input name="sidebar[add][236]" value="1" title="Add To Order" type="checkbox">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <div id="order-sidebar_bottom_button">
                                        <div class="sub-btn-set">
                                            <button id="id_c8f4097854b99546601d6d17c7c53a0b" type="button" class="scalable" onclick="order.sidebarApplyChanges()"
                                                style="">
                                                <span>Update Changes</span></button></div>
                                    </div>
                                </div>
                        ...
                        <td class="main-col">
                            <div id="order-search" style="display: none;" class="order-search-items">
                                <div class="entry-edit">
                                    <div class="entry-edit-head">
                                        <div style="float: right;">
                                            <button id="id_4958273ef3154bbed45739bcd11466ff" type="button" class="scalable add"
                                                    ...
                                                    <tr>
                                                        <td class="pager">
                                                            ...
                                                            <a href="#" title="Next page" onclick="sales_order_create_search_gridJsObject.setPage('2');return false;">
                                                                <img src="sales_order_create_1_files/pager_arrow_right.gif" alt="Go to Next page"
                                                                    class="arrow"></a> of 11 pages <span class="separator">|</span> View
                                                        ...
                                                        <td class="filter-actions a-right">
                                                            <button id="id_cfec7d76f6f251daa77938ef9482c692" type="button" class="scalable" onclick="sales_order_create_search_gridJsObject.resetFilter()"
                                                                style="">
                                                                <span>Reset Filter</span></button>
                                                            <button id="id_a5e83ca43872ee5c82c0a8224d3e6a7f" type="button" class="scalable task"
                                ...
                                <div class="entry-edit">
                                    <div class="entry-edit-head">
                                        ...
                                        <div class="form-buttons">
                                            <button id="id_764715243dadd6047187799fb97ed47a" type="button" class="scalable add"
                                                ...
                                                <table class="form-list" cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="value">
                                                                <select id="group_id" name="order[account][group_id]" class="required-entry required-entry select">
                                                                    ...
                                                                    <option value="5" selected="selected">Trade Buyer</option>
                                                                </select>
                                                            </td>
                                                            <td id="note_group_id">
                                                                <small>&nbsp;</small>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="value">
                                                                <input id="email" name="order[account][email]" value="tom@kal-design.co.uk" class="required-entry required-entry input-text"
                                                                    type="text">
                                                            </td>
                                                            <td id="note_email">
                                                                <small>&nbsp;</small>
                                        ...
                                        <fieldset class="np">
                                            <div class="order-choose-address">
                                                ...
                                                <select id="order-billing_address_customer_address_id" name="order[billing_address][customer_address_id]"
                                                    ...
                                                    <option value="6" selected="selected">thomas wilson, 33 Torksey Street, Scunthorpe,
                                                        North Lincolnshire DN21 4PW, United Kingdom </option>
                                                </select>
                                                <br>
                                                &nbsp;
                                            </div>
                                                        ...
                                                        <table class="form-list" cellspacing="0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="value">
                                                                        <input id="order-billing_address_firstname" name="order[billing_address][firstname]"
                                                                            value="thomas" class="required-entry required-entry input-text" type="text">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="value">
                                                                        <input id="order-billing_address_lastname" name="order[billing_address][lastname]"
                                                                            value="wilson" class="required-entry required-entry input-text" type="text">
                                                                    </td>
                                                                    <td id="note_lastname">
                                                                        <small>&nbsp;</small>
                                                                    </td>
                                                                    ...
                                                                    <td class="value">
                                                                        <div class="multi-input">
                                                                            <input id="order-billing_address_street0" name="order[billing_address][street][0]"
                                                                                value="33 Torksey Street" class="input-text required-entry" type="text">
                                                                        </div>
                                                                        <div class="multi-input">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="value">
                                                                        <input id="order-billing_address_city" name="order[billing_address][city]" value="Scunthorpe"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="value">
                                                                        <input id="order-billing_address_region" name="order[billing_address][region]" value="North Lincolnshire"
                                                                            class="input-text" type="text">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="value">
                                                                        <input id="order-billing_address_postcode" name="order[billing_address][postcode]"
                                                                            value="DN21 4PW" class="required-entry required-entry input-text" type="text">
                                                                    </td>
                                                                    <td id="note_postcode">
                                                                        <small>&nbsp;</small>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="value">
                                                                        <input id="order-billing_address_telephone" name="order[billing_address][telephone]"
                                                                            value="01652 648246" class="required-entry required-entry input-text" type="text">
                                                                    </td>
                                    ...
                                    <div class="entry-edit">
                                        ...
                                        <fieldset class="np">
                                                        ...
                                                        <table class="form-list" cellspacing="0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="value">
                                                                        <input id="order-shipping_address_city" name="order[shipping_address][city]" value="Scunthorpe"
                                                                            class="required-entry required-entry input-text" type="text">
                                                                    </td>
                                                                    <td id="note_city">
                                                                        <small>&nbsp;</small>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="value">
                                                                        <input id="order-shipping_address_region" name="order[shipping_address][region]"
                                                                            value="North Lincolnshire" class="input-text" type="text">
                                            ...
                                            <div style="display: none; position: absolute; background-color: rgb(153, 153, 153);
                                                opacity: 0.8; width: 447px; height: 605px; top: 431px; left: 789px;" id="address-shipping-overlay"
                                                class="overlay">
                                ...
                                <div id="order-shipping_method" class="box-right">
                                    <div class="entry-edit">
                                        ...
                                        <div class="fieldset">
                                            ...
                                            <div style="display: none; position: absolute; background-color: rgb(153, 153, 153);
                                                opacity: 0.8; width: 447px; height: 62px; top: 1051px; left: 789px;" id="shipping-method-overlay"
                                                class="overlay">
                            ...
                            <div class="box-right entry-edit">
                                ...
                                <div id="order-totals" class="order-totals">
                                    ...
                                    <div class="order-totals-bottom">
                                        ...
                                        <p>
                                            <button id="id_c6011d523d41946f31da8a59c7c6c5b4" type="button" class="scalable" onclick="order.submit()"
                                                style="">
                                                <span>Submit Order</span></button></p>
                                    </div>
                                </div>
